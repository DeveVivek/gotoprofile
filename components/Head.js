...
const defaultTitle = 'gotoProfile';
const defaultDescription = 'A nicer look at your GitHub profile. With charts!';
const defaultOGURL = 'https://gotoprofile.DeveVivek.now.sh';
const defaultOGImage = 'https://gotoprofile.DeveVivek.now.sh/static/og.png';
...
const Head = props => (
  <NextHead>
    ...
    <meta name="twitter:creator" content={'@DeveVivek'} />
